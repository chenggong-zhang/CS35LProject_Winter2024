...
function Post ({ userhandle, publicname, timestamp, albumCover, songName, artistName }) {
  ...
  const handleHandshakeButtonClick = () => {
    // Handle the button click event
  };
  ...
  return (
    <div className="Post">
        <div className="VibeStatus"> 
            <div className='vibe-text'>{isVibing ? 'NOW VIBING...' : 'VIBE'}</div>
        </div>
        ...
        <div className="InteractionBar">
          <InteractionButton.LikeButton onClick={handleLikeButtonClick} />
          <InteractionButton.HandshakeButton onClick={handleHandshakeButtonClick} />
          <InteractionButton.FireButton onClick={handleFireButtonClick} />
          <InteractionButton.SadButton onClick={handleSadButtonClick} />
          <InteractionButton.LOLButton onClick={handleLOLButtonClick} />
          <InteractionButton.GGsButton onClick={handleGGsButtonClick} />
        </div>
